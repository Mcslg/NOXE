...
async function callGemini(apiKey: string, prompt: string, isJson: boolean = false, model: string = DEFAULT_MODEL): Promise<string> {
  if (!apiKey) {
...
export async function generateCards(topic: string, apiKey: string): Promise<StudyCard[]> {
